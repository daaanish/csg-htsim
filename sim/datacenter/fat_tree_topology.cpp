...
void
FatTreeTopology::set_downlink_speeds(linkspeed_bps tor_down, linkspeed_bps agg_down, linkspeed_bps core_down) {
    _downlink_speeds[TOR_TIER] = tor_down;
    _downlink_speeds[AGG_TIER] = agg_down;
    _downlink_speeds[CORE_TIER] = (_tiers == 3 ? core_down : agg_down);
}
